...
LABELS = open(r'C:\Users\Waseem K\Desktop\Intership\Day-3\Assig-11 Social distance\coco.names').read().strip().split('\n')
...
neural_net = cv2.dnn.readNetFromDarknet(r'C:\Users\Waseem K\Desktop\Intership\Day-3\Assig-11 Social distance\yolov3.cfg', r'C:\Users\Waseem K\Desktop\Intership\Day-3\Assig-11 Social distance\yolov3.weights')
...
vs = cv2.VideoCapture(r'C:\Users\Waseem K\Desktop\Intership\Day-3\Assig-11 Social distance\sample.jpg')
writer = None
(W, H) = (None, None)
'''
try:
...
while True:
    ...
    if writer is None:
        ...
        writer = cv2.VideoWriter(r'C:\Users\Waseem K\Desktop\Intership\Day-3\Assig-11 Social distance\output.avi', fourcc, 30,(frame.shape[1], frame.shape[0]), True)

    cv2.imshow('output',frame)    
    writer.write(frame)
    cv2.waitKey(200000000)
